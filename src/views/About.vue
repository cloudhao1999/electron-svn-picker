...
<template>
  <div>
    <p class="text-xl font-bold mt-5">关于本项目</p>
    <p class="mt-1">
      使用Vue.js、Vite.js、Electron技术构建的界面化Subversion提取工具 🔧
      ，支持选择改动的文件，生成改动列表记录并组织成文件夹，方便查看和提取。
    </p>
    <p class="text-xl font-bold mt-5">版本</p>
    <p class="mt-1">
      {{ pkg.version }}
    </p>
